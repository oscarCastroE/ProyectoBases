---------------------------- Recuperación de Datos (TABLA DISTRITOS) ----------------------------
...
---------------------------- Recuperación de Datos (TABLA CANTONES) ----------------------------
...
---------------------------- Recuperación de Datos (TABLA PROVINCIA) ----------------------------
...
---------------------------- Recuperación de Datos (LLAVES FORÁNEAS) ----------------------------
...
-- Conseguimos las llaves foráneas "cod_can" de la tabla "cantones",
-- utilizando relaciones topológicas.
...
-- Verificamos que la llave foránea se actualizara correctamente.
-- select * from distritosSF;

-- Conseguimos las llaves foráneas "cod_prov" de la tabla "provincias",
-- utilizando relaciones topológicas.
...
---------------------------- Recuperación de Datos (CENTROS DE SALUD) ----------------------------
...
-- Ahora voy a agrupar las zonas de riesgo de acuerdo a todas las características que no son la geometría.
